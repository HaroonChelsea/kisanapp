                    ...
                    <div class="user-profile-details">
                        <div class="order-history">
                            <div class="header-area d-flex align-items-center">
                                ...
                                <a data-toggle="modal" data-target="#vendorform" class="mybtn1 ml-3" href="javascript:;">
                                    ...
                                    <div class="contact-form">
                                        <form id="emailreply">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <input type="email" class="input-field" id="eml" name="email"
                                                        placeholder="{{ $langg->lang363 }} *" required="">
                                                </li>


                                                <li>
                                                    <input type="text" class="input-field" id="subj" name="subject"
                                                        placeholder="{{ $langg->lang364 }} *" required="">
                                                </li>

                                                <li>
                                                    <textarea class="input-field textarea" name="message" id="msg" placeholder="{{ $langg->lang365 }} *"
                                                        required=""></textarea>
                                                </li>
                                            ...
                                            <button class="submit-btn" id="emlsub"
                                                type="submit">{{ $langg->lang366 }}</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
