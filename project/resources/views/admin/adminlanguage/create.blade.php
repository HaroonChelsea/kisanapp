            ...
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add Language') }} <a class="add-btn"
                            href="{{ route('admin-tlang-index') }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a>
                    </h4>
                    <ul class="links">
                        <li>
                                        ...
                                        <div class="featured-keyword-area">
                                            ...
                                            <div class="lang-tag-top-filds" id="lang-section">
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">New Conversation(s).</textarea>
                                                        </div>

                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">New Conversation(s).</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">You Have a New Message.</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Product(s) in Low Quantity.</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">New Notification(s).</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">A New User Has Registered.</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">You Have a new order.</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">No New Notifications.</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Change Password</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Pending Orders</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Processing Orders</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Completed Orders</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Declined Orders</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Add New Product</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Deactivated Product</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Affiliate Products</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Add Affiliate Product</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">All Affiliate Products</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Customers List</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Vendor Subscriptions</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Vendor Subscription Plans</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Manage Categories</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Main Category</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Child Category</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Bulk Product Upload</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Product Discussion</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Product Reviews</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                      ...
                                      <textarea  name="values[]" class="input-field" placeholder="Enter Language Value" required="">Blog</textarea>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">General Settings</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Pickup Locations</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Website Contents</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Affiliate Information</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Home Page Settings</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Right Side Banner1</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Right Side Banner2</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Top Small Banners</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Large Banners</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Bottom Small Banners</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Home Page Customization</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Contact Us Page</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Email Settings</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Email Template</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Email Configurations</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Payment Settings</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Payment Information</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Payment Gateways</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Social Settings</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Facebook Login</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Language Settings</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Website Language</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Admin Panel Language</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Popular Products</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Google Analytics</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">Website Meta Keywords</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Manage Staffs</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <textarea name="keys[]" class="input-field" placeholder="Enter Language Key"
                                                                required="">System Activation</textarea>
                                                        </div>
                                                ...
                                                <div class="lang-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea name="values[]" class="input-field" placeholder="Enter Language Value"
                                                                required="">Generate Backup</textarea>
                                                        </div>
                                                    </div>
                                                </div>
