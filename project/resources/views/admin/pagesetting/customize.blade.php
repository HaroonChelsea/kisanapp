                        ...
                        <div class="col-lg-12">
                            ...
                            <form id="geniusform" action="{{ route('admin-ps-homeupdate') }}" method="POST"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        <label class="control-label"
                                            for="featured_category">{{ __('Featured Category') }} *</label>
                                        <label class="switch">
                                            <input type="checkbox" name="featured_category" value="1"
                                                {{ $data->featured_category == 1 ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-2"></div>
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        <label class="control-label" for="small_banner">{{ __('Top Small Banner') }}
                                            *</label>
                                        <label class="switch">
                                            <input type="checkbox" name="small_banner" value="1"
                                                {{ $data->small_banner == 1 ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        <label class="control-label" for="large_banner">{{ __('Large Banner') }}
                                            *</label>
                                        <label class="switch">
                                            <input type="checkbox" name="large_banner" value="1"
                                                {{ $data->large_banner == 1 ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="col-lg-2"></div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        <label class="control-label" for="bottom_small">{{ __('Bottom Small Banner') }}
                                            *</label>
                                        <label class="switch">
                                            <input type="checkbox" name="bottom_small" value="1"
                                                {{ $data->bottom_small == 1 ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        <label class="control-label"
                                            for="hot_sale">{{ __('Hot, New, Trending & Sale') }} *</label>
                                        <label class="switch">
                                            <input type="checkbox" name="hot_sale" value="1"
                                                {{ $data->hot_sale == 1 ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    <div class="col-lg-2"></div>
