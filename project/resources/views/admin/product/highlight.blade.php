                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-prod-feature', $data->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Highlight in') }} {{ $langg->lang26 }} *
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div style="display: none" class="row">
                                    <div class="col-lg-8">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Highlight in') }} {{ $langg->lang27 }} *
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Highlight in') }} {{ $langg->lang28 }} *
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div style="display: none" class="row">
                                    <div class="col-lg-8">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Highlight in') }} {{ $langg->lang29 }} *
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div style="display: none" class="row">
                                    <div class="col-lg-8">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Highlight in') }} {{ $langg->lang30 }} *
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div style="display: none" class="row">
                                    <div class="col-lg-8">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Highlight in') }} {{ $langg->lang31 }} *
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div style="display: none" class="row">
                                    <div class="col-lg-8">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Highlight in') }} {{ $langg->lang32 }} *
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div style="display: none" class="row">
                                    <div class="col-lg-8">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Highlight in') }} {{ $langg->lang33 }} *
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div style="display: none" class="row">
                                    <div class="col-lg-8">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Highlight in') }} {{ $langg->lang244 }}
                                                *</h4>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
