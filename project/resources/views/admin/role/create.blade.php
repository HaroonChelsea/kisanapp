...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add Role') }} <a class="add-btn"
                            href="{{ route('admin-role-index') }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a>
                    </h4>
                    <ul class="links">
                        <li>
                    ...
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-role-create') }}" method="POST"
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 d-flex justify-content-between">
                                        <label class="control-label">{{ __('Vendors & Vendor Verifications') }}
                                            *</label>
                                        <label class="switch">
